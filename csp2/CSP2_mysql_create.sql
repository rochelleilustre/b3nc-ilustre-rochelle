...
ALTER TABLE `product` ADD CONSTRAINT `product_fk3` FOREIGN KEY (`stocks_id`) REFERENCES `stocks`(`id`);

ALTER TABLE `product` ADD CONSTRAINT `product_fk4` FOREIGN KEY (`packaging_id`) REFERENCES `packaging`(`id`);
...
ALTER TABLE `place_order` ADD CONSTRAINT `place_order_fk1` FOREIGN KEY (`buyer_id`) REFERENCES `customer`(`id`);

ALTER TABLE `place_order` ADD CONSTRAINT `place_order_fk2` FOREIGN KEY (`reference_number`) REFERENCES `purchase`(`reference_number`);
